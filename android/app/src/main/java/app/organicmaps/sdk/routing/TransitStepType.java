...
public enum TransitStepType
{
  ...
  SUBWAY(R.drawable.ic_route_planning_metro),
  TRAIN(R.drawable.ic_route_planning_train),
  LIGHT_RAIL(R.drawable.ic_route_planning_train),
  MONORAIL(R.drawable.ic_route_planning_monorail),
